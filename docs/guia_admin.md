...
- Dá para editar com o torneio em andamento: o Relógio continua no mesmo Nível. Se você editar ou remover o próprio Nível atual, o Relógio pausa e volta para a duração cheia do Nível
...
- **Avançar nível** — vai para o próximo Nível com a duração cheia. Se o Relógio estava correndo, continua correndo
- **Voltar nível** — volta para o Nível anterior com a duração cheia e **pausado** (voltar é correção de um avanço errado; aperte play para continuar)
...
- Se dois admins apertarem o mesmo botão ao mesmo tempo, o segundo vê **"A mesa mudou, recarregue e tente de novo"** — nada é aplicado duas vezes
